...
from utils.pncc import pncc, draw_norm_faces
...
def main(args):
    ...
    dense_flag = args.opt in ('2d_dense', '3d', 'depth', 'pncc', 'uv_tex', 'ply', 'obj', 'norm')
    ...
    ver_lst, ver_lst_o = tddfa.recon_vers(param_lst, roi_box_lst, dense_flag=dense_flag)
    ...
    if args.opt == '2d_sparse':
        ...
        draw_norm_faces(img, ver_lst, ver_lst_o)
    elif args.opt == '3d':
...
if __name__ == '__main__':
    ...
    parser.add_argument('-o', '--opt', type=str, default='2d_sparse',
                        choices=['2d_sparse', '2d_dense', '3d', 'depth', 'pncc', 'uv_tex', 'pose', 'ply', 'obj', 'norm'])
